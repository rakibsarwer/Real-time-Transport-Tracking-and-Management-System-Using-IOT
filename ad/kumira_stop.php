                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="user-data m-b-30">
                                ...
                                <div class="filters m-b-45">
                                    <!-- TOP CAMPAIGN-->
                                    <?php
                                    $sql1 = "SELECT * FROM bus_info WHERE 1";
                                    ...
                                    if (mysqli_num_rows($result1) > 0) {
                                        ...
                                        while($row1 = mysqli_fetch_assoc($result1)) {
                                            ...
                                            echo "<div><h4>".$bus_no." No Bus Record</h4><table class='table table-bordered'><thead><tr><th>TRIP NUMBER</th><th>BUS NO</th><th>BUS STOPAGE</th><th>IN TIME</th><th>OUT TIME</th></tr></thead><tbody>";

                                            // output data of each row


                                            $sql2 = "SELECT * FROM bus_stop WHERE bus_id='$bus_no'";
